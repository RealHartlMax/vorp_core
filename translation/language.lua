Translation = {
    English      = {
        Notify          = {
            ...
            error = " type 0 for cash, 1 for gold, 2 for rol and 3 for pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                ...
                label = "VORPcore command to remove money (cash, gold, rol, pesos)",
                help = 'player ID',
                help1 = 'Type 0 for cash, 1 for gold, 2 for rol and 3 for pesos',
                help2 = 'Quantity',
                name = "Id",
                name1 = "type",
                name2 = "Quantity",
            ...
            addMoney = {
                ...
                label = "VORPcore command to give money (cash, gold, rol, pesos)",
                help = 'player ID',
                help1 = 'Type 0 for cash, 1 for gold, 2 for rol and 3 for pesos',
                help2 = 'Quantity',
                name = "Id",
    ...
    Portugues_PT = {
        Notify          = {
            ...
            error = "digite 0 para dinheiro, 1 para ouro, 2 para rol e 3 para pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                ...
                label = "Comando VORPcore para remover dinheiro (dinheiro, ouro, rol e pesos)",
                help = 'ID do jogador',
                help1 = 'Digite 0 para dinheiro, 1 para ouro, 2 para rol e 3 para pesos',
                help2 = 'Quantidade',
                name = "Id",
                name1 = "Tipo",
                name2 = "Quantidade",
            ...
            addMoney = {
                ...
                label = "Comando VORPcore para dar dinheiro (dinheiro, ouro, rol e pesos)",
                help = 'ID do jogador',
                help1 = 'Digite 0 para dinheiro, 1 para ouro, 2 para rol e 3 para pesos',
                help2 = 'Quantidade',
                name = "Id",
    ...
    Italian      = {
        Notify          = {
            ...
            error = " digita 0 per denaro contante, 1 per oro, 2 per rol e 3 per pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                custom = "\n**IDPlayer** `%d` \n**Tipo** `%d`\n**Quantità** `%d`",
                title = "📋` /delmoney` ",
                label = "Comando VORPcore per rimuovere denaro (contanti, oro, rol e pesos)",
                help = 'ID Player',
                help1 = 'Tipo 0 per contanti, 1 per l\'oro, 2 per rol e 3 per pesos',
                help2 = 'Quantità',
                name = "Id",
                name1 = "Tipo",
                name2 = "Quantità",
            ...
            addMoney = {
                custom = "\n**IDPlayer** `%d` \n**Tipo** `%d`\n**Quantità** `%d`",
                title = "📋` /addmoney` ",
                label = "Comando VORPcore per dare denaro (contanti, oro, rol e pesos)",
                help = 'ID Player',
                help1 = 'Tipo 0 per contanti, 1 per l\'oro, 2 per rol e 3 per pesos',
                help2 = 'Quantità',
                name = "Id",
    ...
    Spanish      = {
        Notify          = {
            ...
            error = " escribe 0 para dinero, 1 para oro, 2 para rol y 3 para pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                custom = "\n**IDUsuario** `%d` \n**Tipo de Dinero** `%d`\n**Cantidad** `%d`",
                title = "📋` Comando /delmoney` ",
                label = "VORPcore: comando para quitar dinero (efectivo, oro, rol y pesos)",
                help = 'ID Usuario',
                help1 = 'Escribe 0 para efectivo, 1 para oro, 2 para rol y 3 para pesos',
                help2 = 'Cantidad',
                name = "Id",
                name1 = "tipo",
                name2 = "Cantidad",
            ...
            addMoney = {
                custom = "\n**IDUsuario** `%d` \n**Tipo de Dinero** `%d`\n**Cantidad** `%d`",
                title = "📋` Comando /addmoney` ",
                label = "VORPcore: comando para añadir dinero (efectivo, oro, rol y pesos)",
                help = 'ID Usuario',
                help1 = 'Escribe 0 para efectivo, 1 para oro, 2 para rol y 3 para pesos',
                help2 = 'Cantidad',
                name = "Id",
    ...
    Francais     = {
        Notify          = {
            ...
            error = "tapez 0 pour l'argent, 1 pour l'or, 2 pour rol et 3 pour pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                ...
                label = "Commande VORPcore pour retirer de l'argent (liquide, or, rol et pesos)",
                help = 'ID du joueur',
                help1 = 'Tapez 0 pour l\'argent liquide, 1 pour l\'or, 2 pour rol et 3 pour pesos',
                help2 = 'Quantité',
                name = "Id",
                name1 = "Type",
                name2 = "Quantité",
            ...
            addMoney = {
                ...
                label = "Commande VORPcore pour donner de l'argent (liquide, or, rol et pesos)",
                help = 'ID du joueur',
                help1 = 'Tapez 0 pour l\'argent liquide, 1 pour l\'or, 2 pour rol et 3 pour pesos',
                help2 = 'Quantité',
                name = "Id",
    ...
    German       = {
        Notify          = {
            ...
            error = "Geben Sie 0 für Bargeld, 1 für Gold, 2 für Rol und 3 für Pesos ein",
        ...
        Commands        = {
            ...
            delMoney = {
                ...
                label = "VORPcore-Befehl zum Entfernen von Geld (Bargeld, Gold, Rol und Pesos)",
                help = 'Spieler-ID',
                help1 = 'Gib 0 für Bargeld, 1 für Gold, 2 für Rol und 3 für Pesos ein',
                help2 = 'Menge',
                name = "Id",
                name1 = "Typ",
                name2 = "Menge",
            ...
            addMoney = {
                ...
                label = "VORPcore-Befehl zum Geben von Geld (Bargeld, Gold, Rol und Pesos)",
                help = 'Spieler-ID',
                help1 = 'Gib 0 für Bargeld, 1 für Gold, 2 für Rol und 3 für Pesos ein',
                help2 = 'Menge',
                name = "Id",
    ...
    Romanian     = {
        Notify          = {
            ...
            error = " tasteaza 0 pentru bani, 1 pentru aur, 2 pentru rol si 3 pentru pesos",
        ...
        Commands        = {
            ...
            delMoney = {
                ...
                label = "Comanda VORPcore pentru a elimina bani (bani, aur, rol si pesos)",
                help = 'ID jucator',
                help1 = 'Tasteaza 0 pentru bani, 1 pentru aur, 2 pentru rol si 3 pentru pesos',
                help2 = 'Cantitate',
                name = "Id",
                name1 = "tip",
                name2 = "Cantitate",
            ...
            addMoney = {
                ...
                label = "Comanda VORPcore pentru a da bani (bani, aur, rol si pesos)",
                help = 'ID jucator',
                help1 = 'Tasteaza 0 pentru bani, 1 pentru aur, 2 pentru rol si 3 pentru pesos',
                help2 = 'Cantitate',
                name = "Id",
